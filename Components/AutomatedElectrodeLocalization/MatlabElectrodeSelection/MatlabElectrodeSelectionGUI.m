classdef MatlabElectrodeSelectionGUI < uix.HBoxFlex
    ...
    methods (Access = protected)
        ...
        function runFullShankDetection(obj)
            f = waitbar(0,'Running Shank detection');
            ...
            for i=1:length(obj.elDefinition.Definition)
                ...
                waitbar(i/length(obj.elDefinition.Definition),f);
            end
            close(f);
        end
        ...
        function determineThreshold(obj)
            ...
            o.PlotFcns=[];
            o.OutputFcn=[];
            min_res=fminbnd(@(x) obj.testTreshold(Nelecs,x),obj.slMinThresh.Max*0.8,obj.slMinThresh.Max,o);
