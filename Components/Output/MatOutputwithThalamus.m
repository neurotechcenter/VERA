classdef MatOutputwithThalamus < AComponent
    %MatOutputwithThalamus Creates a .mat file of the thalamus similar to neuralact
    ...
    methods
        function obj = MatOutputwithThalamus()
            obj.ElectrodeLocationIdentifier   = 'ElectrodeLocation';
            obj.ElectrodeDefinitionIdentifier = 'ElectrodeDefinition';
            obj.SurfaceIdentifier1            = 'Surface';
            obj.SurfaceIdentifier2            = 'ThalamusSurface';
        end
        ...
        function []= Process(obj, eLocs,eDef,surf1,surf2)
            ...
            Thalamus_annotation.Annotation           = surf2.Annotation;
            Thalamus_annotation.AnnotationLabel      = surf2.AnnotationLabel;
            ...
            save(fullfile(path,file),'cortex','Thalamus','ix','tala','viewstruct','electrodeNames','cmapstruct','vcontribs',...
                'electrodeDefinition','electrodeLabels','LabelName','annotation','Thalamus_annotation','SecondaryLabel');
        end
