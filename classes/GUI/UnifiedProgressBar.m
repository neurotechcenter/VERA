classdef UnifiedProgressBar < handle
    ...
    methods
        function obj=UnifiedProgressBar(handle)
            ...
            obj.progressAnnotation=annotation(obj.suspendBox,'TextBox','string','','BackgroundColor','none','FontSize',12,...
                'units','normalized','Position',[0 0 1 obj.barHeight],'LineWidth',2,'Interpreter','none','VerticalAlignment','middle','HorizontalAlignment','center');
        ...
        function suspendGUIWithMessage(obj,msg)
            ...
            if(~isempty(obj.suspendAnnotation) && (strcmp(obj.suspendBox.Visible,'off')))
        ...
        function IncreaseProgressBar(obj,increase)
            if(~isempty(obj.progressBar))
