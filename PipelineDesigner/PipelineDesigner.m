function PipelineDesigner()
    ...
    uilabel(fig, ...
        ...
        'Text','Pipeline','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Input Components','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Processing Components','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Output Components','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Current Component','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Available Views','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Current View','FontName', 'Arial', 'FontSize', 16);
    ...
    uilabel(fig, ...
        ...
        'Text','Help','FontName', 'Arial', 'FontSize', 16);
